...
/**
 * Traduire: false
 * classeNomCanonique.enUS: org.computate.bancaire.enUS.html.part.HtmlPartEnUSGenApiService
 * Gen: false
 **/
@WebApiServiceGen
@ProxyGen
public interface PartHtmlFrFRGenApiService {
	static void enregistrerService(SiteContexteFrFR siteContexte, Vertx vertx) {
		new ServiceBinder(vertx).setAddress("computate-bancaire-commun-frFR-PartHtml").register(PartHtmlFrFRGenApiService.class, new PartHtmlFrFRApiServiceImpl(siteContexte));
	}
