...
/**
 * Translate: false
 * classCanonicalName.frFR: org.computate.bancaire.frfr.html.part.PartHtmlFrFRGenApiService
 * Gen: false
 **/
@WebApiServiceGen
@ProxyGen
public interface HtmlPartEnUSGenApiService {
	static void registerService(SiteContextEnUS siteContext, Vertx vertx) {
		new ServiceBinder(vertx).setAddress("computate-bancaire-commun-enUS-HtmlPart").register(HtmlPartEnUSGenApiService.class, new HtmlPartEnUSApiServiceImpl(siteContext));
	}
