...
import org.computate.bancaire.frfr.cluster.ClusterFrFRGenApiService;
import org.computate.bancaire.frfr.utilisateur.UtilisateurSiteFrFRGenApiService;
import org.computate.bancaire.frfr.config.ConfigSite;
import org.computate.bancaire.frfr.contexte.SiteContexteFrFR;
import org.computate.bancaire.frfr.java.LocalDateSerializer;
import org.computate.bancaire.frfr.java.ZonedDateTimeSerializer;
...
/**
 * NomCanonique.enUS: org.computate.bancaire.enus.vertx.AppVertx
...
public class AppliVertx extends AppliVertxGen<AbstractVerticle> {
	 ...
	 * r: AnneebancaireFrFRGenApiService
	 * r.enUS: SchoolYearEnUSGenApiService
	 * r: SaisonbancaireFrFRGenApiService
	 * r.enUS: SchoolSeasonEnUSGenApiService
	 * r: SessionbancaireFrFRGenApiService
	 * r.enUS: SchoolSessionEnUSGenApiService
	 * r: AgebancaireFrFRGenApiService
	 * r.enUS: SchoolAgeEnUSGenApiService
	 * r: BlocbancaireFrFRGenApiService
	 * r.enUS: SchoolBlockEnUSGenApiService
	 * r: InscriptionbancaireFrFRGenApiService
	 * r.enUS: SchoolEnrollmentEnUSGenApiService
	 * r: EnfantbancaireFrFRGenApiService
	 * r.enUS: SchoolChildEnUSGenApiService
	 * r: MerebancaireFrFRGenApiService
	 * r.enUS: SchoolMomEnUSGenApiService
	 * r: PerebancaireFrFRGenApiService
	 * r.enUS: SchoolDadEnUSGenApiService
	 * r: ContactbancaireFrFRGenApiService
	 * r.enUS: SchoolContactEnUSGenApiService
	 * r: GardienbancaireFrFRGenApiService
	 * r.enUS: SchoolGuardianEnUSGenApiService
	 * r: PaiementbancaireFrFRGenApiService
...
//		AnneebancaireFrFRGenApiService.enregistrerService(siteContexteFrFR, vertx);
//		SaisonbancaireFrFRGenApiService.enregistrerService(siteContexteFrFR, vertx);
//		SessionbancaireFrFRGenApiService.enregistrerService(siteContexteFrFR, vertx);
//		AgebancaireFrFRGenApiService.enregistrerService(siteContexteFrFR, vertx);
//		BlocbancaireFrFRGenApiService.enregistrerService(siteContexteFrFR, vertx);
//		InscriptionbancaireFrFRGenApiService.enregistrerService(siteContexteFrFR, vertx);
//		EnfantbancaireFrFRGenApiService.enregistrerService(siteContexteFrFR, vertx);
//		MerebancaireFrFRGenApiService.enregistrerService(siteContexteFrFR, vertx);
//		PerebancaireFrFRGenApiService.enregistrerService(siteContexteFrFR, vertx);
//		GardienbancaireFrFRGenApiService.enregistrerService(siteContexteFrFR, vertx);
//		PaiementbancaireFrFRGenApiService.enregistrerService(siteContexteFrFR, vertx);

		Router siteRouteur = siteContexteFrFR.getUsineRouteur().getRouter();

		StaticHandler gestionnaireStatic = StaticHandler.create().setCachingEnabled(false).setFilesReadOnly(true);
		if("bancaire-dev.computate.org".equals(configSite.getSiteNomHote())) {
			gestionnaireStatic.setAllowRootFileSystemAccess(true);
			gestionnaireStatic.setWebRoot("/usr/local/src/computate-bancaire-static");
		}
