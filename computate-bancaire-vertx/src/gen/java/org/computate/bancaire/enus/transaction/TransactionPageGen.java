...
public abstract class TransactionPageGen<DEV> extends TransactionGenPage {
	...
	public void patchRequestTransactionPage() {
		PatchRequest patchRequest = Optional.ofNullable(siteRequest_).map(SiteRequestEnUS::getPatchRequest_).orElse(null);
		TransactionPage original = (TransactionPage)Optional.ofNullable(patchRequest).map(PatchRequest::getOriginal).orElse(null);
		if(original != null) {
			super.patchRequestTransactionGenPage();
		}
	}
