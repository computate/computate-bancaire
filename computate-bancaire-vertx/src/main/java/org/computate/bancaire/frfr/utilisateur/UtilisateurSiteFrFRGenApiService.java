...
/**
 * Traduire: false
 * classeNomCanonique.enUS: org.computate.bancaire.enus.user.SiteUserEnUSGenApiService
 * Gen: false
 **/
@WebApiServiceGen
@ProxyGen
public interface UtilisateurSiteFrFRGenApiService {
	static void enregistrerService(SiteContexteFrFR siteContexte, Vertx vertx) {
		new ServiceBinder(vertx).setAddress("computate-bancaire-commun-frFR-UtilisateurSite").register(UtilisateurSiteFrFRGenApiService.class, new UtilisateurSiteFrFRApiServiceImpl(siteContexte));
	}
