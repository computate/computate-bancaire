...
import org.computate.bancaire.enus.cluster.ClusterEnUSGenApiService;
import org.computate.bancaire.enus.user.SiteUserEnUSGenApiService;
import org.computate.bancaire.enus.config.SiteConfig;
import org.computate.bancaire.enus.contexte.SiteContextEnUS;
import org.computate.bancaire.enus.java.LocalDateSerializer;
import org.computate.bancaire.enus.java.ZonedDateTimeSerializer;
...
//		SchoolPaymentEnUSGenApiService.registerService(siteContextEnUS, vertx);
		...
		if("bancaire-dev.computate.org".equals(siteConfig.getSiteHostName())) {
			staticHandler.setAllowRootFileSystemAccess(true);
			staticHandler.setWebRoot("/usr/local/src/computate-bancaire-static");
		}
