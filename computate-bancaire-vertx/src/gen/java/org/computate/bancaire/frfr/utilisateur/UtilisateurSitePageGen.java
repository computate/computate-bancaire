...
import org.computate.bancaire.frfr.utilisateur.UtilisateurSiteGenPage;
...
/**	
 * <br/><a href="http://localhost:10383/solr/computate/select?q=*:*&fq=partEstClasse_indexed_boolean:true&fq=classeNomCanonique_frFR_indexed_string:org.computate.bancaire.frfr.utilisateur.UtilisateurSitePage&fq=classeEtendGen_indexed_boolean:true">Trouver la classe  dans Solr</a>
 * <br/>
 **/
public abstract class UtilisateurSitePageGen<DEV> extends UtilisateurSiteGenPage {
	...
	public void requetePatchUtilisateurSitePage() {
		RequetePatch requetePatch = Optional.ofNullable(requeteSite_).map(RequeteSiteFrFR::getRequetePatch_).orElse(null);
		UtilisateurSitePage original = (UtilisateurSitePage)Optional.ofNullable(requetePatch).map(RequetePatch::getOriginal).orElse(null);
		if(original != null) {
			super.requetePatchUtilisateurSiteGenPage();
		}
	}
